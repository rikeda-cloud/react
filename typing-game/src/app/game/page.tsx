...
function GamePage() {
  ...
  const { question, romaji, idx, questionTimeProgress, gameTimeProgress, score, isGameFinished }
    = useTypingGame();
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="text-center w-full max-w-4xl px-4">
        ...
        <p className="text-2xl font-bold text-white mb-4">Score: <span className="text-yellow-400">{score}</span></p>
